...
//! configuration part reports a 1.44 MB floppy, a coprocessor, and the
//! base and extended memory sizes. Register 0Fh is the shutdown status byte
//! that tells the BIOS, after a CPU reset, whether to resume a program
//! through the pointer at 40:67 (used by 286-era protected mode code).
...
impl Cmos {
    ...
    pub fn new(extended_kb: u32) -> Self {
        ...
        ram[0x10] = 0x40; // drive A: 1.44 MB, no drive B
        ram[0x14] = 0x03; // floppy installed, math coprocessor present
